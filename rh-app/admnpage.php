...
include_once 'user.php';
  ...
  if(isset($_SESSION["userData"])){
    ...
    else if ($user->getusertype()=='respo'){
...
$user = $_SESSION["userData"];
$stm = $PDO->prepare("SELECT * FROM users WHERE user_type <> 'admin' ");
$stm->execute();
$result = $stm->fetchAll();
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
 ...
 <div class="container ">
        <h2 class="display-5 mt-5"><?php echo "Welcome, ".$user->getName();?></h2>
        
        
                <a class="btn btn-lg btn-primary" href="newadmin.php" role="button"><h6 class="display-8 ">ADD NEW ADMIN ?</h6></a>
            <br><br>
        <ul class="list-group">
            ...
            <li class="list-group-item d-flex justify-content-between align-items-center">
                ...
                <span>
                <span><a class="btn btn-primary" href="infoemp.php?id=<?=$item['ID'];?>&Name=<?=$item['Name'];?>">Détails</a></span>
                <a class="btn btn-primary" href="delete.php?deleteuser=1&id=<?=$item['ID'];?>" >DEL</a>
                </span>
            </li>
            <?php } ?>
