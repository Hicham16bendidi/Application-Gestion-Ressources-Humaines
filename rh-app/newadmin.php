   ...
   include_once 'user.php';
       ...
       if(isset($_POST['Register'])){
            ...
            if($Password!=$Password1){
              ...
              $newadmin = new admin('',$Name, $Username, $type, $Password);
   
              $stm = $PDO->prepare("INSERT INTO users (Name, Username, user_type, Password) VALUES (?,?,?,?)");
              $result = $stm->execute([$newadmin->getName(),$newadmin->getuserName(),$newadmin->getusertype(),$newadmin->getPassword()]);
              var_dump($result);
          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <p class="text-center text-white h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">New Admin</p>

                <form class="mx-1 mx-md-4" action="newadmin.php" enctype="multypart/form-data" method="POST">
                  ...
                  <p class="text-center text-muted mt-5 mb-0">Abandon? <a href="admnpage.php" class="fw-bold text-body"><u>Cancel</u></a></p>
                  <br></br>
                  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                    <button type="submit" class="btn btn-dark btn-lg px-5" name="Register">Register</button>
                  </div>
